...
public class ManagerUpdateInfoServlet extends HttpServlet {
	

    public ManagerUpdateInfoServlet() {
        super();
    }

    private ManagerUserServices managerUserServices = new ManagerUserServices();
    
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		
		request.getRequestDispatcher("/managerupdatepersonalinfo.html").forward(request, response);
	}
